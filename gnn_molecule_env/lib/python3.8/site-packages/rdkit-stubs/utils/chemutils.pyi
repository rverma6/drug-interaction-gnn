...
def ConfigToNumElectrons(config, ignoreFullD = 0, ignoreFullF = 0):
    ...
    """
def GetAtomicData(atomDict, descriptorsDesired, dBase = '/Users/runner/work/rdkit-pypi/rdkit-pypi/build/temp.macosx-10.9-x86_64-cpython-38/rdkit_install/share/RDKit/Data/atomdb.gdb', table = 'atomic_data', where = '', user = 'sysdba', password = 'masterkey', includeElCounts = 0):
    """
...
def SplitComposition(compStr):
    ...
    """
_atomDbName: str = '/Users/runner/work/rdkit-pypi/rdkit-pypi/build/temp.macosx-10.9-x86_64-cpython-38/rdkit_install/share/RDKit/Data/atomdb.gdb'
